...
class Book{
    ...
    //Getter: Setter methodundan girilen değeri döndürür.
    //Değişken değerimize ulaşmak istediğimiz yerlerde getter methodunu kullanılır.
    //Setter: Method parametre değerini ayarlar.
    //Değişken değerimize farklı veya yeni bir değer girmek istediğimiz yerlerde setter methodunu kullanılır
    //getter all variable
    ...
    //her nesne için tek tek yazdırma yapmak yerine,metgod belirleyerek
    //tek kod içerisinde birden fazla işlem yapılır
